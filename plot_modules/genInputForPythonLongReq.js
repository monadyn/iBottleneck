...
new lazy(fs.createReadStream('./timerange.txt'))
	...
	.forEach(function(line) {
		...
		darr.push(linestr);
			...
			var cmdstr = 'python aggregateInOutPut_ClientTier_longReq.py ' + year1 + month1 + date1 + hour1 + min1 + sec1 + '-' + min2 + sec2 + ' ' + year1 + month1 + date1 + hour1 + min1 + ' ' + year1 + month1 + date1 + hour1 + min2 + ' ' + conc;
